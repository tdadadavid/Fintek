...
func (q *Queries) GetTransfersFromAccountID(ctx context.Context, fromAccountID int32) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransfersFromAccountID, fromAccountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTransfersToAccountID(ctx context.Context, toAccountID int32) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransfersToAccountID, toAccountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
